...
const LINEUP_INCLUDES =
  "participants;state;league;scores;lineups;lineups.player;lineups.type;lineups.details.type;statistics.type;statistics.participant;venue;coaches;metadata";
